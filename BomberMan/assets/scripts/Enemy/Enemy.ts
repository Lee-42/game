import { _decorator, Component, Collider2D, Contact2DType, IPhysics2DContact, RigidBody2D, Animation } from 'cc';
...
export class Enemy extends Component {
    ...
    protected die() {
        ...
        if (this._rb) this._rb.linearVelocity = Object.freeze({ x: 0, y: 0 }) as any; // Stop moving
